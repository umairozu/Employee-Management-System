						...
						<div class="col-md-8" >
							...
							<form method="post" action="#">
								...
								<div class="form-outline mb-3"style="padding-left: 80px;">
									<textarea class="form-control bg-body-tertiary" id="textAreaExample2" rows="7" name="task_reply"></textarea>
									<label class="form-label" style="padding-left: 80px;"for="textAreaExample2">Message</label>
								</div>
						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-body">
									...
									<?php
									// $user_id = $_POST['user_id'];
									$query_replies = "SELECT * FROM `task_reply` join `users` on `users`.`user_id` = `task_reply`.`replied_by`  WHERE `message_id` = '$task_id'";
